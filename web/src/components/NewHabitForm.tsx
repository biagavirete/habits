...
function NewHabitForm({ setIsModalOpen, isModalOpen }: Props) {
  ...
  function handleToggleWeekDay(weekDay: number) {
    if (weekDays.includes(weekDay)) {
      const newValues = weekDays.filter(day => day !== weekDay);
      setWeekDays(newValues);
    } else {
      const newValuesWithAddedOne = [...weekDays, weekDay];
      setWeekDays(newValuesWithAddedOne);
    }
  }
